...
Strapping.prototype.load = function (str, noCompile) {
  ...
  if (jsonObj) {
    if (jsonObj.vars) vars = utils.replaceLessVars(vars.vars);else if (jsonObj.bootstrap && jsonObj.bootstrap.vars) vars = utils.replaceLessVars(jsonObj.bootstrap.vars);
    if (jsonObj.fonts) {
      this.addedFonts = [];
